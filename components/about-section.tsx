        ...
        <div className="space-y-6 md:space-y-8">
          <div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              من يقف خلف هذا <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block">العمل الرائع؟</span>
            </h2>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              نحن فريق من المتخصصين في الذكاء الاصطناعي والرعاية الصحية، نسعى لتوفير أدوات ذكية تساعد الأفراد على فهم حالتهم الصحية بشكل أفضل واتخاذ قرارات وقائية مبكرة.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">نماذج ذكاء اصطناعي دقيقة</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  نستخدم أحدث خوارزميات التعلم الآلي المدربة على مجموعات بيانات طبية ضخمة لضمان دقة التوقعات.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">حلول برمجية متطورة</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  واجهة مستخدم عصرية وسهلة الاستخدام تجعل من عملية الفحص تجربة سريعة ومفيدة للجميع.
                </p>
              </div>
            </div>
          </div>
