      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        <div className="space-y-6 md:space-y-8">
          <h1 className="text-[42px] leading-[1.4] md:text-[62px] font-black md:leading-[1.5] text-zinc-900 dark:text-zinc-100">
            سنفحص <span className="bg-[#FF6B7A] text-white px-3 py-1 inline-flex items-center border-4 border-black dark:border-white shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.1)] -rotate-2">صحة قلبك</span> بواسطة الذكاء الاصطناعي  بناءً على تحليل{" "}
            <span className="bg-[#2F81F7] text-white px-3 py-1 inline-flex items-center border-4 border-black dark:border-white shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.1)] rotate-2">نمط حياتك</span>
          </h1>

          <p className="text-[#393939] dark:text-gray-300 text-[16px] md:text-[20px] font-medium leading-[28px] md:leading-[34px] max-w-xl">
            شارك في استبيان سريع عن عاداتك الغذائية، نشاطك البدني، وحالتك الصحية.. لكي يتوقع الروبوت الخاص بك مدى احتمالية إصابتك بأمراض القلب!
          </p>
